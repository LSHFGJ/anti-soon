...
DOCS_ALLOWED_PATTERNS=(
  ...
  '^frontend/tooling/sync-bountyhub-address\.mjs$'
  ...
  '^frontend/src/__tests__/docs-blocks\.spec\.tsx$'
  '^frontend/src/__tests__/docs-content\.spec\.ts$'
  '^frontend/src/__tests__/docs-multi-page[^/]*\.spec\.tsx$'
  '^frontend/src/__tests__/docs-policy\.spec\.ts$'
  '^frontend/src/__tests__/e2e/docs-multi-page[^/]*\.spec\.ts$'
