	...
	"inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-mono font-semibold transition-all duration-200 ease-linear focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase tracking-wider",
	{
		variants: {
			variant: {
				...
				outline:
					"text-foreground border-neutral-800 hover:border-violet-500/30",
				success:
				...
				info: "border-transparent bg-[var(--color-info-dim)] text-[var(--color-info)] border-[var(--color-info)]/30 shadow-[0_0_10px_var(--color-info-dim)]",
				critical:
					"border-transparent bg-[var(--color-error-dim)] text-[var(--color-error)] border-[var(--color-error)]/30 shadow-[0_0_10px_var(--color-error-dim)]",
				high: "border-transparent bg-[var(--color-error-dim)] text-[var(--color-error)] border-[var(--color-error)]/30 shadow-[0_0_10px_var(--color-error-dim)]",
				medium:
				...
				low: "border-transparent bg-[var(--color-primary-dim)] text-[var(--color-primary)] border-[var(--color-primary)]/30 shadow-[0_0_10px_var(--color-primary-dim)]",
				unique:
				...
				open: "border-[var(--color-primary)]/50 bg-[var(--color-primary-dim)] text-[var(--color-primary)] shadow-[0_0_10px_var(--color-primary-dim)]",
				reveal:
